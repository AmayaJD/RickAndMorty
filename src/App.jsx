...
// Earth (Replacement Dimension) que posicion es este?
function App() {
        ...
        <div className='menu_option'>
          {
            locationsList.map((location, i) => {
                return <button className='pagination__btn' key={i} onClick={ () => setCurrentLocation(location)}> {location.name} </button>
            })
          }
        </div>
